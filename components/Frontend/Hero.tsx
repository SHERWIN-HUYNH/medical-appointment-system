              ...
              <div className="hero-content">
                ...
                <ul className="flex flex-wrap items-center mt-6">
                  <li>
                    <a
                      href="/#"
                      className="inline-flex items-center justify-center rounded-md bg-blue-700 px-6 py-3 text-center text-base font-medium text-white hover:bg-blue-800 lg:px-7"
                    >
                  ...
                  <li>
                    ...
                    >
                      <span className="mr-2">
                        <Pill className="flex-shrink-0 h-4 w-4 text-blue-700" />
                      </span>
                      Need A Refill
                    </a>
                  </li>
