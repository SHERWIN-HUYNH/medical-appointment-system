...
const options: ApexOptions = {
  ...
  labels: ['Nội khoa', 'Ngoại khoa', 'Nhi khoa', 'Khác'],
  legend: {
    show: false,
    position: 'bottom',
  },
        ...
        <div>
          <div className="relative z-20 inline-block">
            <select
              name=""
              id=""
              className="relative z-20 inline-flex appearance-none bg-transparent py-1 pl-3 pr-8 text-xs font-medium outline-none"
            >
