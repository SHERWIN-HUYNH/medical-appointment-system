            ...
            <Card className='mb-3 rounded-lg border border-solid border-[#00e0ff]'>
              <CardHeader>
                <div className=' flex items-center'>
                  <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide text-primary lucide-id-card"><path d="M16 10h2"/><path d="M16 14h2"/><path d="M6.17 15a3 3 0 0 1 5.66 0"/><circle cx="9" cy="11" r="2"/><rect x="2" y="5" width="20" height="14" rx="2"/></svg></p>
                  <h1 className=' font-semibold text-primary text-2xl'>Thông tin thanh toán</h1>
                </div>
              </CardHeader>
              <CardContent>
                ...
                <ul className=' px-2 py-3'>
                  <li className='list-item-payment -mt-4'>
                    <div className='flex items-start gap-x-2'>
                      <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-stethoscope text-iconGray"><path d="M11 2v2"/><path d="M5 2v2"/><path d="M5 3H4a2 2 0 0 0-2 2v4a6 6 0 0 0 12 0V5a2 2 0 0 0-2-2h-1"/><path d="M8 15a6 6 0 0 0 12 0v-3"/><circle cx="20" cy="10" r="2"/></svg></p>
                  ...
                  <li className='list-item-payment'>
                    ...
                    <p className='li-payment-center'>Khám Tự Chọn Yêu Cầu (Tầng 2,3 - Khu B)</p>
                  </li>
                  <li className='list-item-payment'>
                    <div className='flex items-center gap-x-2'>
                      <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-stethoscope text-iconGray"><path d="M11 2v2"/><path d="M5 2v2"/><path d="M5 3H4a2 2 0 0 0-2 2v4a6 6 0 0 0 12 0V5a2 2 0 0 0-2-2h-1"/><path d="M8 15a6 6 0 0 0 12 0v-3"/><circle cx="20" cy="10" r="2"/></svg></p>
                    ...
                    <p className='li-payment-center'>16/12/2024</p>
                  </li>
                  <li className='list-item-payment'>
                    <div className='flex items-center gap-x-2'>
                      <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-stethoscope text-iconGray"><path d="M11 2v2"/><path d="M5 2v2"/><path d="M5 3H4a2 2 0 0 0-2 2v4a6 6 0 0 0 12 0V5a2 2 0 0 0-2-2h-1"/><path d="M8 15a6 6 0 0 0 12 0v-3"/><circle cx="20" cy="10" r="2"/></svg></p>
...
function Form({price}:{price:string}) {
  ...
  return (
    <form onSubmit={handleSumit}>
      <Card className='mb-3 rounded-lg border border-solid border-[#00e0ff]'>
      <CardHeader>
        <CardTitle className='font-semibold text-primary text-2xl'>Thông tin thẻ</CardTitle>
        {errorMessage && (
      ...
      <CardFooter>
        <Button className='text-white' disabled={!stripe || !elements}>  {isLoading
              ? "Purchasing..."
