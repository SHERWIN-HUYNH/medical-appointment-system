...
export const DOCTOR_STATUS_ACTIVE_APPOINTMENT_EXIST =
  'Bác sĩ này đang có lịch hẹn không thể chuyển trạng thái'
export const DOCTOR_FACULTY_ACTIVE_APPOINTMENT =
