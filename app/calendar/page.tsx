      ...
      <section className=" flex  space-x-7  max-w-screen-xl px-4 pb-6 mt-8">
        <div className=" w-67 rounded-lg bg-white h-max">
            ...
            <ul className="px-3 py-4 flex flex-col gap-3">
              ...
              <li className="text-16-normal flex ">
              <div className=" mr-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-clipboard-plus"><rect width="8" height="4" x="8" y="2" rx="1" ry="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><path d="M9 14h6"/><path d="M12 17v-6"/></svg></div>
                <div className="flex justify-center flex-col">
              ...
              <li className="text-16-normal flex ">
              <div className=" mr-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-stethoscope"><path d="M11 2v2"/><path d="M5 2v2"/><path d="M5 3H4a2 2 0 0 0-2 2v4a6 6 0 0 0 12 0V5a2 2 0 0 0-2-2h-1"/><path d="M8 15a6 6 0 0 0 12 0v-3"/><circle cx="20" cy="10" r="2"/></svg></div>
                <div className="flex justify-center flex-col">
                  <p>Bác sĩ: Cao Thỉ</p>
              ...
              <li className="text-16-normal flex ">
              <div className=" mr-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-house-plus"><path d="M13.22 2.416a2 2 0 0 0-2.511.057l-7 5.999A2 2 0 0 0 3 10v9a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7.354"/><path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"/><path d="M15 6h6"/><path d="M18 3v6"/></svg></div>
                <div className="flex justify-center flex-col">
              ...
              />
                ...
                <div>
                  ...
                  <ul className="center my-4">
                    <li className=" min-w-40"><Button className=" timeSlot">07:30 - 08:30</Button></li>
                    <li className=" min-w-40"><Button className=" activeTimeSlot">08:30 - 09:00</Button></li>
                    <li className=" min-w-40"><Button className=" timeSlot">09:00 - 09:30</Button></li>
                    <li className=" min-w-40"><Button className=" timeSlot">09:30 - 10:00</Button></li>
                  </ul>
                </div>
                <div>
                  <h1 className=" text-[#000000d9] font-bold text-lg">
                  ...
                  <ul className="center my-4">
                    <li className=" min-w-40"><Button className=" timeSlot">07:30 - 08:30</Button></li>
                    <li className=" min-w-40"><Button className=" timeSlot">08:30 - 09:00</Button></li>
                    <li className=" min-w-40"><Button className=" activeTimeSlot">09:00 - 09:30</Button></li>
                    <li className=" min-w-40"><Button className="activeTimeSlot">09:30 - 10:00</Button></li>
                  </ul>
                </div>
                <div>
...
Nếu không chọn được khung giờ phù hợp, bạn có thể đặt khám tại Bệnh viện Đại học Y Dược Cơ sở 201 Nguyễn Chí Thanh, Phường 12, Quận 5
                  </p>
                </div>
              </div>}
